...
async function handleRoomDeny(
  ...
  if (!memberInRoom) {
    ...
    return tempFollowUp(
      interaction,
      `${safeMemberName(selected)} không có mặt trong phòng này.`,
      'warning'
    );
  }
  ...
  if (!beforePermission) {
    ...
    return tempFollowUp(
      interaction,
      `${safeMemberName(selected)} không còn có mặt trong phòng này.`,
      'warning'
    );
  }
  ...
  if (!denied) {
    return tempFollowUp(
      interaction,
      `Không thể cấm ${safeMemberName(beforePermission)}.`,
      'error'
    );
  }
  ...
  try {
    ...
    return tempFollowUp(
      interaction,
      'Không thể lưu dữ liệu cấm. Thay đổi quyền đã được hoàn tác.',
      'error'
    );
  }
  ...
  if (beforeDisconnect) {
    ...
    if (
      ...
      if (stillInRoom) {
        ...
        return tempFollowUp(
          interaction,
          `Không thể đưa ${safeMemberName(beforeDisconnect)} ra khỏi phòng nên thao tác Cấm đã được hoàn tác.`,
          'error'
        );
      }
    }
  ...
  return tempFollowUp(
    interaction,
    `Đã cấm ${safeMemberName(beforePermission)} khỏi phòng.`,
    'success'
  );
}
...
async function handleRoomKick(
  ...
  if (!finalCheck) {
    ...
    return tempFollowUp(
      interaction,
      `${safeMemberName(member)} không còn có mặt trong phòng này.`,
      'warning'
    );
  }
  ...
  if (!disconnected.ok) {
    if (
      ...
      return tempFollowUp(
        interaction,
        `${safeMemberName(finalCheck)} không còn có mặt trong phòng này.`,
        'warning'
      );
    }
    ...
    return tempFollowUp(
      interaction,
      `Không thể đuổi ${safeMemberName(finalCheck)} khỏi phòng.`,
      'error'
    );
  }
  ...
  return tempFollowUp(
    interaction,
    `Đã đuổi ${safeMemberName(finalCheck)} khỏi phòng.`,
    'success'
  );
}
...
/* =========================================================
   12. HEALTH SERVER
   Dùng healthServer đã được tạo ở P1, không khai báo lại.
   ========================================================= */
